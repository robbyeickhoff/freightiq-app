            ...
            {expandedSection === "search" && (
              <View style={styles.contentPanel}>
                <Text style={styles.step}>
                  Every report you add helps the next driver make a better delivery. Together,
                  drivers create the kind of real-world knowledge that maps and GPS can’t provide.
                </Text>
              </View>
            )}
          </View>
          ...
          {expandedSection === "deliveryZone" && (
            <View style={styles.contentPanel}>
              <Text style={styles.step}>
                ...
                procedures, parking, unloading, or anything that could save time or prevent
                confusion.
              </Text>
            </View>
          )}
