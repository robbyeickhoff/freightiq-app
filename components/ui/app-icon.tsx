...
const ICONS = {
  ...
  close: { default: "close" },
  complete: { default: "check-circle-outline", active: "check-circle" },
  ...
  mail: { default: "mail-outline" },
  privacy: { default: "privacy-tip" },
  community: { default: "gpp-good" },
  blocked: { default: "block" },
  delete: { default: "delete-outline" },
  drag: { default: "drag-handle" },
