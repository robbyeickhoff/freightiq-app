...
| Decide Refer a Driver referral mechanics | `docs/field-notes/entries/2026-08-06-0046-refer-a-driver.md` | Product idea | Waiting for a decision | Decide whether this becomes a later referral feature tied to the Founding Driver / Programs area, and reconcile the 5-5-5 $5/$5 reward rules with the existing Founding Driver referral documentation before any implementation or build-spec change. | Medium | 2026-08-05 |
