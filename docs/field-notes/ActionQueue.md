...
| Build Refer a Driver referral program | `docs/build-specs/FreightIQReferralProgramV1BuildSpec.md` | Feature improvement | Engineering complete; user test pending | Run the approved one-referrer / one-new-account test for QR and link capture, 5-day and 5-stop progress, admin approval, qualification, and the two $5 rewards. | High | 2026-08-08 |
