...
| Incorporate vehicle positioning into Routing Lab | `docs/field-notes/entries/2026-07-28-vehicle-positioning-turnaround-downtown-telluride.md` | Routing lesson | Ready to work | During the next approved Routing Lab documentation workflow, add vehicle positioning as a reusable lesson and candidate evaluation category while preserving the unresolved first-class lesson-type decision and need for additional examples. | High | 2026-08-10 |
| Add correction impact scoring to Routing Lab | `docs/field-notes/entries/2026-08-06-routing-lab-correction-impact-scoring.md` | Routing lesson | Ready to work | During the next approved Routing Lab workflow, decide how Critical, Moderate, Minor, and Equivalent corrections should be assigned and weighted, then incorporate the approved model into the lesson review and evaluation documentation. | High | 2026-08-10 |
