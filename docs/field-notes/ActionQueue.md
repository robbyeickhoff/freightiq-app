...
| Build Refer a Driver referral program | `docs/build-specs/FreightIQReferralProgramV1BuildSpec.md` | Feature improvement | Verified complete | Referral V1 passed Product Owner acceptance. During the next normal TestFlight build, verify the installed-app Open in FreightIQ stop handoff; no separate build is required. | High | 2026-08-08 |
| Create in-app Contact Support flow | `docs/field-notes/entries/2026-08-06-0047-contact-support.md` | Feature improvement | Ready to work | Create a focused in-app Contact Support build spec or Codex task that adds Contact Support under Settings → Support below Help Center, preserves Help Center as self-service, and defines V1 support request behavior without changing the existing website Contact page contract. | Medium | 2026-08-05 |
