...
| Complete Google Search Console and DNS setup | `docs/field-notes/entries/2026-07-29-2152-complete-google-search-console-dns-setup.md` | Operational concern | Verified complete | No further setup action is currently available; monitor normal Search Console indexing and capture any future issue as a separate finding. | High | 2026-07-30 |
| Polish Stop Intel Contact / Check-In fields | `docs/field-notes/entries/2026-07-30-1342-stop-intel-contact-check-in-polish.md` | Feature improvement | Verified complete | Multiple named contacts, the five-phone report limit, persistence, report grouping, actions, deletion, focused-field keyboard behavior, and compact collapsible editor cards passed on iPhone and Pixel. | Medium | 2026-07-30 |
...
| Decide whether to create FreightIQ Founding 10 program | `docs/field-notes/entries/2026-07-30-1615-founding-driver-rewards-program.md` | Product idea | Verified complete | Founding Driver Program V0, its protected operating surfaces, public Request to Join flow, and launch runbook were implemented and accepted. Driver #1 enrollment remains a separate operational decision, not unfinished work from this Field Note. | Medium | 2026-07-30 |
...
| Incorporate vehicle positioning into Routing Lab | `docs/field-notes/entries/2026-07-28-vehicle-positioning-turnaround-downtown-telluride.md` | Routing lesson | Verified complete | The approved Slice 3 Build Specification adds vehicle positioning as an operational reason and lesson category without creating a separate lesson engine; real examples are still required before further specialization. Implementation is tracked in `docs/MasterTODO.md`. | High | 2026-08-10 |
| Add correction impact scoring to Routing Lab | `docs/field-notes/entries/2026-08-06-routing-lab-correction-impact-scoring.md` | Routing lesson | Verified complete | The approved Slice 3 Build Specification makes impact driver-approved metadata, allows a system suggestion, and defers numeric weighting until real evidence supports a separate decision. Implementation is tracked in `docs/MasterTODO.md`. | High | 2026-08-10 |
| Build Refer a Driver referral program | `docs/field-notes/entries/2026-08-06-0046-refer-a-driver.md` | Product idea | Verified complete | Referral V1 passed Product Owner acceptance. Installed-candidate handoff verification remains tracked as a release gate in `docs/CurrentBuild.md`, not as unfinished Field Notes implementation. | High | 2026-08-08 |
| Create in-app Contact Support flow | `docs/field-notes/entries/2026-08-06-0047-contact-support.md` | Feature improvement | Verified complete | Contact Support is implemented through the live website form with an email fallback, and its native presentation passed focused iPhone and Pixel acceptance as part of the approved App Store Trust & Safety build. | Medium | 2026-08-05 |
