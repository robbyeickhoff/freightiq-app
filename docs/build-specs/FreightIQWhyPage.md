...
Create a focused public page that tells the personal origin story of FreightIQ in the founder’s own voice. This page builds trust with drivers by explaining why the product exists, without repeating the problem-focused pages or product marketing.

It should feel direct, practical, and written by a driver for other drivers.
...
Why I Built FreightIQ | FreightIQ

## Meta Description

I’ve been running freight in Western Colorado for 12 years. Here’s why I built FreightIQ — and why the practical knowledge drivers already have should be easier to save and share.
...
**Secondary link:** See a real example →

---

## Design Notes

- Follow the FreightIQ Sunrise System (colors, typography, `.eyebrow`, surface treatments)
- Keep the tone practical, calm, first-person, and driver-first
- Use the same header, footer, and button styles as the rest of the public site
- Do not introduce new visual patterns without approval
- This page should feel more personal and less “product marketing” than the other content pages
- Generous line spacing and readable measure for longer first-person text
