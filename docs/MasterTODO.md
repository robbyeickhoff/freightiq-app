...
- [x] Install preview build 7 on the registered iPhone and pass the real-world movement test with
      three successful alerts along the driving route.
- [ ] Test leave-and-return suppression, offline/stale recovery, navigation handoff, force-stop
      behavior, practical battery effect, and the complete Pixel contract.
